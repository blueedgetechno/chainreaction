...
fun ChainReactionNavGraph(navController: NavHostController) {
    ...
    NavHost(
        ...
        composable(
            ...
            val mode = backStackEntry.arguments?.read { getString("mode") } ?: "local"
            GameSetupScreen(
        ...
        composable(
            ...
            val action = backStackEntry.arguments?.read { getString("action") } ?: "create"
            val code = backStackEntry.arguments?.read { getString("code") } ?: ""
            OnlineGameScreen(
                action = action,
                roomCode = code,
                onExit = {
